                        ...
                        <div class="bg-secondary border-0 p-3">
                            <div class="px-md-5 py-4">
                                ...
                                <div class="text-center text-muted mb-4">
                                    <small>Informe a nova senha desejada</small>
                                </div>

                                <form role="form" method="get" wire:target="resetPassword"
                                    ...
                                    <div class="form-group">
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input class="form-control" type="password" name="password_confirmation"
                                                wire:model.defer="password_confirmation" placeholder="Confirmar">
                                        </div>
                                    ...
                                    <button type="submit" wire:loading.attr="disabled"
                                        ...
                                        <span wire:loading.remove wire:target="resetPassword">Salvar</span>
                                        <i wire:loading wire:target="resetPassword" class="fas fa-spinner fa-pulse"></i>
                                    </button>
